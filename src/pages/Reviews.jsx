        ...
        <div className="wrapper text-white pt-[3rem]">
          <div className="grid md:grid-cols-2 gap-7">
            {Array(5)
              .fill(0)
              .map((_, i) => (
                <div className="backdrop-blur-md bg-white/5 transition-all duration-300 relative border border-primary flex-shrink-0 p-8 rounded-2xl py-6">
            ...
            >
              ...
              <div className="flex flex-col gap-4">
                <div className="grid grid-cols-1">
                  ...
                  <Rating
                    emptySymbol={
                      <MdOutlineStarPurple500 size={30} stroke="0" />
                    }
                    fullSymbol={
                      <MdOutlineStarPurple500
                        size={30}
