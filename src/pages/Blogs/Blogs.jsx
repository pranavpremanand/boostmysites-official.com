...
export const BlogItem = ({ blog }) => {
  return (
    <div
      data-aos="fade-up"
      className="bg-black rounded-xl p-5 text-white relative z-10 group flex flex-col justify-between gap-5"
    >
      <div>
        <Link to={`/blogs/${blog.link}/boostmysites-review`}>
          <img
            loading="lazy"
            src={blog.image}
            alt=""
        ...
        <div className="flex flex-col gap-2 mt-[1rem]">
          <Link
            to={`/blogs/${blog.link}/boostmysites-review`}
