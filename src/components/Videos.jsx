...
import vid1Thumb from "../assets/videos/vid1.png";
import vid2Thumb from "../assets/videos/vid2.png";
import vid3Thumb from "../assets/videos/vid3.png";
import vid4Thumb from "../assets/videos/vid4.png";
import vid5Thumb from "../assets/videos/vid5.png";
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 justify-center gap-5 wrapper">
        <div className="h-[50vh] md:h-[60vh] max-h-[35rem] relative">
          ...
          {isVideoLoading.video1 && (
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
              <img src={vid1Thumb} className="h-full w-full object-cover rounded-[1rem]" alt="thumbnail" />
            </div>
          )}
          <ReactPlayer
            ref={video1Ref}
        ...
        <div className="h-[50vh] md:h-[60vh] max-h-[35rem] relative">
          ...
          {isVideoLoading.video2 && (
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
              <img src={vid2Thumb} className="h-full w-full object-cover rounded-[1rem]" alt="thumbnail" />
            </div>
          )}
          <ReactPlayer
            ref={video2Ref}
        ...
        <div className="h-[50vh] md:h-[60vh] max-h-[35rem] relative">
          ...
          {isVideoLoading.video3 && (
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
              <img src={vid3Thumb} className="h-full w-full object-cover rounded-[1rem]" alt="thumbnail" />
            </div>
          )}
          <ReactPlayer
            ref={video3Ref}
        ...
        <div className="h-[50vh] md:h-[60vh] max-h-[35rem] relative">
          ...
          {isVideoLoading.video4 && (
            <div className="absolute top-0 left-0 w-full h-full flex justify-center items-center">
              <img src={vid4Thumb} className="h-full w-full object-cover rounded-[1rem]" alt="thumbnail" />
            </div>
          )}
          <ReactPlayer
            ref={video4Ref}
      ...
      <div className="h-[60vh] aspect-[4/6] mx-auto md:h-[70vh] max-h-[35rem] relative">
        ...
        {isVideoLoading.video5 && (
          <div className="absolute top-0 left-0 w-full h-[60vh] md:h-[70vh] max-h-[35rem] flex justify-center items-center">
            <img src={vid5Thumb} className="h-full w-full object-cover rounded-[1rem]" alt="thumbnail" />
          </div>
        )}
        <ReactPlayer
